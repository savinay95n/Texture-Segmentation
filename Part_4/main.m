%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% main.m file %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Purpose:  
%      Perform the texture segmentation on d4d29.gif
%
% Input Variables:
%      Text_Img           input d4d29.gif image
%      
% Returned Results:
...
%      2.  Apply the Gabor filter with F=0.6038, theta=-50.5 & sigma=8 with 
